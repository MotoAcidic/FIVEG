...
1. Clone the FIVEG Core source code:

        git clone https://github.com/fiveg-project/fiveg
        cd fiveg
...
Before running, you may create an empty configuration file:
    ...
    mkdir -p "/Users/${USER}/Library/Application Support/FIVEG"

    touch "/Users/${USER}/Library/Application Support/FIVEG/fiveg.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/FIVEG/fiveg.conf"

The first time you run fivegd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
