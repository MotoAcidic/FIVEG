Contributing to FIVEG Core
============================

The FIVEG Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/fiveg-project/fiveg/blob/master/doc/translation_process.md)
...
The following applies to code changes to the FIVEG Core project, and is not to be
confused with overall FIVEG Network Protocol consensus changes.

Whether a pull request is merged into FIVEG Core rests with the project merge
...
Patches that change FIVEG consensus rules are considerably more involved than
...
Where a patchset proposes to change the FIVEG consensus, it must have been
...
The project leader is the release manager for each FIVEG Core release.
