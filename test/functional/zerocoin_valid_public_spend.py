...
from fake_stake.base_test import FIVEG_FakeStakeTest

class zVGValidCoinSpendTest(FIVEG_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zVGs..." % DENOM_TO_USE)
