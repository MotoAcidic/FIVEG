...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "fiveg" is a composite category enabling all FIVEG-related debug output
            if (ptrCategory->count(string("fiveg"))) {
...
// Windows < Vista: C:\Documents and Settings\Username\Application Data\FIVEG
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "fiveg.conf"));
    ...
    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty fiveg.conf if it does not exist
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "fivegd.pid"));
