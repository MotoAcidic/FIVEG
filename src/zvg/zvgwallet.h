...
#ifndef FIVEG_ZVGWALLET_H
#define FIVEG_ZVGWALLET_H
...
public:
    CzVGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZVG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZVG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
