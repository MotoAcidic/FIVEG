...
#ifndef FIVEG_ZVGTRACKER_H
#define FIVEG_ZVGTRACKER_H
...
public:
    CzVGTracker(std::string strWalletFile);
    ~CzVGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzVGWallet* zVGWallet = NULL);
