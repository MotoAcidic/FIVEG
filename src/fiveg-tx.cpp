...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FIVEG Core fiveg-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fiveg-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fiveg transaction") + "\n" +
                               "  fiveg-tx [options] -create [commands]   " + _("Create hex-encoded fiveg transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fiveg transaction
