...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::VG);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeFIVEGAmount"))
        SoftSetArg("-anonymizefivegamount", settings.value("nAnonymizeFIVEGAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in fiveg.cpp during shotdown to also remove the window positions
