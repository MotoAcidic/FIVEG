                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVGPathCustom = GetArg("-zvgbackuppath", "");
    ...
    if(!strzVGPathCustom.empty()) {
        ui->wallet_customzvgbackuppath->setText(QString::fromStdString(strzVGPathCustom));
        ui->wallet_customzvgbackuppath_label->setVisible(true);
        ui->wallet_customzvgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FIVEG RPC console.") + "<br>" +
