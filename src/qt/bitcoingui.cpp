                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("FIVEG Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVG"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About FIVEG Core"), this);
    aboutAction->setStatusTip(tr("Show information about FIVEG Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for FIVEG"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the FIVEG Core help message to get a list with possible FIVEG command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("FIVEG Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("FIVEG Core"); // default title
