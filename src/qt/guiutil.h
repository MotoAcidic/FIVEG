...
/** Utility functions used by the FIVEG Qt UI.
 */
namespace GUIUtil
{
...
// Render FIVEG addresses in monospace font
...
// Parse "fiveg:" URI into recipient object, return true on successful parsing
