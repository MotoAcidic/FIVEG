...
/* FIVEG GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "FIVEG"
#define QAPP_ORG_DOMAIN "fiveg.org"
#define QAPP_APP_NAME_DEFAULT "FIVEG-Qt"
#define QAPP_APP_NAME_TESTNET "FIVEG-Qt-testnet"
