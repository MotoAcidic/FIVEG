...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FIVEG features */
        {"fiveg", "listmasternodes", &listmasternodes, true, true, false},
        {"fiveg", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fiveg", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fiveg", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"fiveg", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"fiveg", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"fiveg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fiveg", "masternodedebug", &masternodedebug, true, true, false},
        {"fiveg", "startmasternode", &startmasternode, true, true, false},
        {"fiveg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fiveg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fiveg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fiveg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fiveg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fiveg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fiveg", "preparebudget", &preparebudget, true, true, false},
        {"fiveg", "submitbudget", &submitbudget, true, true, false},
        {"fiveg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fiveg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fiveg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fiveg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fiveg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fiveg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fiveg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fiveg", "checkbudgets", &checkbudgets, true, true, false},
        {"fiveg", "mnsync", &mnsync, true, true, false},
        {"fiveg", "spork", &spork, true, true, false},
        {"fiveg", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzvgseed", &getzvgseed, false, false, true},
        {"zerocoin", "setzvgseed", &setzvgseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzvg", &searchdzvg, false, false, true},
        {"zerocoin", "dzvgstate", &dzvgstate, false, false, true},
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23019/\n";
}
