...
extern UniValue DoZvgSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzvgseed(const UniValue& params, bool fHelp);
extern UniValue getzvgseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzvg(const UniValue& params, bool fHelp);
extern UniValue dzvgstate(const UniValue& params, bool fHelp);
