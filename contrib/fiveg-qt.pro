...
RESOURCES += src/qt/fiveg.qrc src/qt/fiveg_locale.qrc

TRANSLATIONS += src/qt/locale/fiveg_bg.ts \
                src/qt/locale/fiveg_de.ts \
                src/qt/locale/fiveg_en.ts \
                src/qt/locale/fiveg_es.ts \
                src/qt/locale/fiveg_fi.ts \
                src/qt/locale/fiveg_fr.ts \
                src/qt/locale/fiveg_it.ts \
                src/qt/locale/fiveg_ja.ts \
                src/qt/locale/fiveg_pl.ts \
                src/qt/locale/fiveg_pt.ts \
                src/qt/locale/fiveg_ru.ts \
                src/qt/locale/fiveg_sk.ts \
                src/qt/locale/fiveg_sv.ts \
                src/qt/locale/fiveg_vi.ts \
                src/qt/locale/fiveg_zh_CN.ts \
                src/qt/locale/fiveg_zh_TW.ts
